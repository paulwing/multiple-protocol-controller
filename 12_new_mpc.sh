...
docker run -d --name $CONTAINER_NAME --restart=always \
	...
	-e "JUDGE_SOURCE_STREAM=judge:source" \
	-e "JUDGE_SOURCE_WRITE_TIMEOUT_MS=${IOT_JUDGE_SOURCE_WRITE_TIMEOUT_MS:-200}" \
	-e "JUDGE_SOURCE_RETRY_COUNT=${IOT_JUDGE_SOURCE_RETRY_COUNT:-1}" \
	-e "JUDGE_SOURCE_RETRY_INTERVAL_MS=${IOT_JUDGE_SOURCE_RETRY_INTERVAL_MS:-20}" \
